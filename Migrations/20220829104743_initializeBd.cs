        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetTaskId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Links", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Links_Tasks_SourceTaskId",
                        column: x => x.SourceTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Links_Tasks_TargetTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Links_SourceTaskId",
                table: "Links",
                column: "SourceTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_Links_TargetTaskId",
                table: "Links",
                column: "TargetTaskId");
